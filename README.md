...
- 已知问题：
  ...
  - 对于引号、省略号、1 em 横线等中英文共用的标点取舍问题尚未解决。本字体引号采用 Unicode 16.0 标准化变体序列（Standardized Variation Sequences, SVS）在西文引号  `“‘’”` 和中文引号 `“︁‘︁’︁”︁` 之间选择，省略号和 1 em 横线（半破折号）使用西文字体的字符。
